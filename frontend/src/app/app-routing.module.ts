...
import { PelangganFormComponent } from './pages/master/pelanggan/pelanggan-form.component';
export const routes: Routes = [
  ...
  { path: 'pelanggan/form', component: PelangganFormComponent },
  { path: 'pelanggan/form/:id', component: PelangganFormComponent },
  {
    path: 'auth',
